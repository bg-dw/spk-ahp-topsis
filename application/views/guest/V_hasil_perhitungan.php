                ...
                <div class="row">
                    <div class="col-md-12 col-md-4">
                        <div class="alert alert-success" role="alert">
                            Berdasarkan hasil perhitungan, " <?= $terpilih[0]['lokasi'] ?> " terpilih sebagai lokasi terbaik. Harap klik <button class="btn btn-success" onclick="location.href='<?= base_url('c_perhitungan/lokasi/' . $terpilih[0]['id']) ?>'">Lihat Lokasi</button> untuk melihat lokasi pada peta.
                        </div>
                    </div>
                </div>
