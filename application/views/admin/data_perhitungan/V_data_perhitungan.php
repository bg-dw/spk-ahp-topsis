    ...
    <div class="col-md-12 col-lg-12">
        <div class="card">
            <div class="card-header">
                ...
                <button class="btn btn-primary ml-auto" onclick="location.href='<?= base_url() ?>admin/c_data_perhitungan/add_data_perhitungan/';">Tambah</button>
            </div>
            <div class="card-body">
                            ...
                            foreach ($lokasi as $val) : ?>
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <button class="btn btn-warning btn-sm" onclick="location.href='<?= base_url() ?>admin/c_data_perhitungan/update_data_perhitungan/<?= $val->id_lokasi ?>';">Edit</button>
...
<div id="modal-del" class="modal fade">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <form action="<?= base_url() ?>admin/c_data_perhitungan/delete_data_perhitungan/" method="post">
